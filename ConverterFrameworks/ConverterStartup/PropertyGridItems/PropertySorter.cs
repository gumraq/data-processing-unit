...
namespace ConverterStartup.PropertyGridItems
{
    public class PropertySorter : ExpandableObjectConverter
    {
        ...
        /// <summary>/// Возвращает упорядоченный список свойств/// </summary>
    ...
    /// <summary>/// Пара имя/номер п/п с сортировкой по номеру/// </summary>
    public class PropertyOrderPair : IComparable
    {
        ...
        /// <summary>/// Собственно метод сравнения/// </summary>
